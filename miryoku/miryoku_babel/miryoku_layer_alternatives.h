...
U_MT(SQT, Q),             &kp W,             &kp E,             &kp R,             &kp T,             U_MT(MINUS, Y),             U_MT(EQUAL, U),             U_MT(LEFT_BRACKET, I),             U_MT(RIGHT_BRACKET, O),             U_MT(BACKSLASH, P),             \
U_MT(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, D),    U_MT(LSHFT, F),    &kp G,             &kp H,             U_MT(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, SEMICOLON),   \
